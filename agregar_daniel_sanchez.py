"""
Script para agregar la persona CORRECTA: Daniel Sanchez Mendoza (diferente)
"""
import sys
import os
import sqlite3
...
def agregar_daniel_sanchez():
    """Agrega Daniel Sanchez Mendoza (persona diferente) a censo y cooperación"""
    
    print("\n" + "="*80)
    print("AGREGAR PERSONA CORRECTA: Daniel Sanchez Mendoza (Diferente)")
    print("="*80 + "\n")
    ...
    # Datos de la persona
    nombre = "* Daniel Sanchez Mendoza"  # Con asterisco para diferenciar
    ...
    try:
        # Verificar si ya existe con el asterisco
