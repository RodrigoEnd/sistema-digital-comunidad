...
Punto de entrada principal que inicia todos los componentes del sistema
"""
...
def main():
    ...
    if not verificar_api():
        print("La API no está activa. Iniciando...")
        if not iniciar_api():
        ...
        print("API ya está activa")
    
    # Iniciar el sistema de censo (interfaz principal)
    iniciar_censo()
